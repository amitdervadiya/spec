                ...
                <div className='w-[85%] bg-[var(--brown)]   max-sm:gap-[20px] max-sm:flex-col max-sm:h-max flex justify-between max-sm:px-3 max-sm:py-5 px-[50px] items-center'>
                    ...
                    <div className='flex  justify-center items-center text-[var(--black)] gap-6 max-sm:gap-4  max-sm:text-center '>
                        <div className='flex  flex-col gap-[20px] max-sm:gap-[10px] justify-center items-center bg-white  p-5 max-sm:p-2'>
                            <a href="https://wa.me/9016699400" target="_blank" className='flex gap-2 max-sm:flex-col justify-center items-center font-semibold text-[20px] max-sm:text-[13px]'><img src={whatssapp} alt="" className='w-[30px] max-sm:w-5 ' /> WHATSAPP </a>
                        ...
                        <div className='flex  flex-col gap-[20px] max-sm:gap-[10px] justify-center items-center bg-white  max-sm:text-center   p-5 max-sm:p-2'>
                            <span href="" className='flex gap-2 max-sm:flex-col justify-center items-center font-semibold text-[20px] max-sm:text-[13px]'><img src={headset} alt="" className='w-[30px] max-sm:w-5' />  Customer Support   </span>
                            <p className='flex flex-col max-sm:text-[14px] font-medium justify-center max-sm:text-center items-center text-[18px]'>Need Help in Buying Call ΤΟ 
                                <a href="tel:+919879368602<"> <span className='font-semibold'>+91 98793 68602</span></a> </p>
                        </div>
